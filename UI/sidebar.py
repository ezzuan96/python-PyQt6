...
class MySideBar(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.dashboard_1.toggle()
        self.dashboard_2.toggle()
        ...
        self.setting_1.clicked.connect(self.switch_to_settingsPage)
        self.setting_2.clicked.connect(self.switch_to_settingsPage)
